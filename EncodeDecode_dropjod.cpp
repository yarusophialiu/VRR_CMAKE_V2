...
void EncodeDecode::initPairList() {
    ...
    // max jod vs 0.25
    // manager.addStimulus(ExperimentStimulus("living_room", "path4_seg3_1", 1500, 720, 70, 1.f, 0.4f, 0));
    // manager.addStimulus(ExperimentStimulus("living_room", "path4_seg3_1", 1500, 1080, 120, 1.f, 0.6f, 0));
    ...
    manager.addStimulus(ExperimentStimulus("living_room", "path1_seg3_1", 1500, 720, 80, 1.f, 0.4f, 1));
    manager.addStimulus(ExperimentStimulus("living_room", "path1_seg3_1", 1500, 1080, 110, 1.f, 0.6f, 1));
    manager.addStimulus(ExperimentStimulus("living_room", "path5_seg2_1", 2000, 720, 80, 1.f, 0.4f, 2));
    manager.addStimulus(ExperimentStimulus("living_room", "path5_seg2_1", 2000, 1080, 110, 1.f, 0.6f, 2));

    manager.addStimulus(ExperimentStimulus("lost_empire", "path1_seg2_3", 1000, 360, 110, 3, 0.4f, 3));
    manager.addStimulus(ExperimentStimulus("lost_empire", "path1_seg2_3", 1000, 720, 120, 3, 0.6f, 3));
    manager.addStimulus(ExperimentStimulus("lost_empire", "path5_seg2_3", 1500, 360, 110, 3, 0.4f, 4));
    manager.addStimulus(ExperimentStimulus("lost_empire", "path5_seg2_3", 1500, 720, 120, 3, 0.6f, 4));

    // manager.addStimulus(ExperimentStimulus("lost_empire", "path5_seg3_1", 1000, 360, 110, 1, 0.4f, 0));
    // manager.addStimulus(ExperimentStimulus("lost_empire", "path5_seg3_1", 1000, 720, 120, 1, 0.6f, 0));
    // manager.addStimulus(ExperimentStimulus("room", "path1_seg2_3", 500, 360, 100, 3.f, 0.4f, 1));
    // manager.addStimulus(ExperimentStimulus("room", "path1_seg2_3", 500, 720, 120, 3, 0.6f, 1));
    // manager.addStimulus(ExperimentStimulus("room", "path4_seg1_2", 2000, 360, 100, 2.f, 0.4f, 2));
    // manager.addStimulus(ExperimentStimulus("room", "path4_seg1_2", 2000, 720, 120, 2.f, 0.6f, 2));
    // manager.addStimulus(ExperimentStimulus("room", "path4_seg2_1", 500, 360, 100, 1.f, 0.4f, 3));
    // manager.addStimulus(ExperimentStimulus("room", "path4_seg2_1", 500, 720, 120, 1.f, 0.6f, 3));
    // manager.addStimulus(ExperimentStimulus("suntemple", "path3_seg3_3", 500, 360, 80, 3.f, 0.4f, 4));
    // manager.addStimulus(ExperimentStimulus("suntemple", "path3_seg3_3", 500, 720, 110, 3.f, 0.6f, 4));
    // manager.addStimulus(ExperimentStimulus("suntemple", "path5_seg1_2", 1500, 720, 110, 2.f, 0.4f, 5));
    // manager.addStimulus(ExperimentStimulus("suntemple", "path5_seg1_2", 1500, 1080, 120, 2.f, 0.6f, 5));

    // manager.addStimulus(ExperimentStimulus("suntemple", "path2_seg1_3", 1000, 480, 80, 3.f, 0.4f, 0));
    // manager.addStimulus(ExperimentStimulus("suntemple", "path2_seg1_3", 1000, 720, 120, 3.f, 0.6f, 0));
    // manager.addStimulus(ExperimentStimulus("gallery", "path5_seg2_2", 2000, 720, 80, 2.f, 0.4f, 1));
    // manager.addStimulus(ExperimentStimulus("gallery", "path5_seg2_2", 2000, 1080, 110, 2.f, 0.6f, 1));
    // manager.addStimulus(ExperimentStimulus("gallery", "path3_seg2_1", 1500, 720, 50, 1.f, 0.4f, 3));
    // manager.addStimulus(ExperimentStimulus("gallery", "path3_seg2_1", 1500, 1080, 80, 1.f, 0.6f, 3));
    // manager.addStimulus(ExperimentStimulus("gallery", "path1_seg3_1", 1500, 720, 70, 1.f, 0.4f, 4));
    // manager.addStimulus(ExperimentStimulus("gallery", "path1_seg3_1", 1500, 1080, 90, 1.f, 0.6f, 4));


    // manager.addStimulus(ExperimentStimulus("bedroom", "path3_seg2_3", 500, 360, 70, 3.f, 0.4f, 15));
    // manager.addStimulus(ExperimentStimulus("bedroom", "path3_seg2_3", 500, 720, 120, 3.f, 0.6f, 15));
    // manager.addStimulus(ExperimentStimulus("bedroom", "path2_seg2_3", 1000, 360, 80, 3.f, 0.4f, 16));
    // manager.addStimulus(ExperimentStimulus("bedroom", "path2_seg2_3", 1000, 720, 120, 3.f, 0.6f, 16));
    // manager.addStimulus(ExperimentStimulus("bedroom", "path2_seg1_1", 2000, 720, 40, 1.f, 0.4f, 17));
    // manager.addStimulus(ExperimentStimulus("bedroom", "path2_seg1_1", 2000, 720, 110, 1.f, 0.6f, 17));

    // manager.addStimulus(ExperimentStimulus("bistro", "path3_seg3_1", 2000, 720, 80, 1.f, 0.4f, 18));
    // manager.addStimulus(ExperimentStimulus("bistro", "path3_seg3_1", 2000, 1080, 120, 1.f, 0.6f, 18));
    // manager.addStimulus(ExperimentStimulus("bistro", "path4_seg1_3", 500, 360, 80, 3.f, 0.4f, 19));
    // manager.addStimulus(ExperimentStimulus("bistro", "path4_seg1_3", 500, 720, 120, 3.f, 0.6f, 19));
    // manager.addStimulus(ExperimentStimulus("bistro", "path4_seg2_2", 1000, 360, 100, 2.f, 0.4f, 20));
    // manager.addStimulus(ExperimentStimulus("bistro", "path4_seg2_2", 1000, 720, 120, 2.f, 0.6f, 20));

    // manager.addStimulus(ExperimentStimulus("crytek_sponza", "path5_seg2_3", 1500, 480, 70, 3, 0.4f, 21));
    // manager.addStimulus(ExperimentStimulus("crytek_sponza", "path5_seg2_3", 1500, 720, 120, 3, 0.6f, 21));
    // manager.addStimulus(ExperimentStimulus("crytek_sponza", "path1_seg1_2", 1000, 480, 80, 2, 0.4f, 22));
    // manager.addStimulus(ExperimentStimulus("crytek_sponza", "path1_seg1_2", 1000, 720, 120, 2, 0.6f, 22));
    // manager.addStimulus(ExperimentStimulus("crytek_sponza", "path1_seg2_3", 1000, 480, 80, 3, 0.4f, 23));
    // manager.addStimulus(ExperimentStimulus("crytek_sponza", "path1_seg2_3", 1000, 720, 120, 3, 0.6f, 23));




    // max jod vs 0.4
    // manager.addStimulus(ExperimentStimulus("bedroom", "path3_seg2_3", 500, 360, 60, 3.f, 0.4f, 0));
    // manager.addStimulus(ExperimentStimulus("bedroom", "path3_seg2_3", 500, 720, 120, 3.f, 0.6f, 0));
    // manager.addStimulus(ExperimentStimulus("bedroom", "path2_seg2_3", 1000, 360, 70, 3.f, 0.4f, 1));
    // manager.addStimulus(ExperimentStimulus("bedroom", "path2_seg2_3", 1000, 720, 120, 3.f, 0.6f, 1));
    // manager.addStimulus(ExperimentStimulus("bedroom", "path2_seg2_2", 1000, 360, 80, 2.f, 0.4f, 2));
    // manager.addStimulus(ExperimentStimulus("bedroom", "path2_seg2_2", 1000, 720, 120, 2.f, 0.6f, 2));

    // manager.addStimulus(ExperimentStimulus("bistro", "path3_seg3_1", 2000, 720, 70, 1.f, 0.4f, 2));
    // manager.addStimulus(ExperimentStimulus("bistro", "path3_seg3_1", 2000, 1080, 120, 1.f, 0.6f, 2));
    // manager.addStimulus(ExperimentStimulus("bistro", "path4_seg1_3", 500, 360, 70, 3.f, 0.4f, 3));
    // manager.addStimulus(ExperimentStimulus("bistro", "path4_seg1_3", 500, 720, 120, 3.f, 0.6f, 3));
    // manager.addStimulus(ExperimentStimulus("bistro", "path3_seg3_3", 2000, 360, 80, 3.f, 0.4f, 2));
    // manager.addStimulus(ExperimentStimulus("bistro", "path3_seg3_3", 2000, 720, 120, 3.f, 0.6f, 2));

    // manager.addStimulus(ExperimentStimulus("crytek_sponza", "path1_seg1_3", 1000, 360, 80, 3.f, 0.4f, 0));
    // manager.addStimulus(ExperimentStimulus("crytek_sponza", "path1_seg1_3", 1000, 720, 120, 3.f, 0.6f, 0));
    // manager.addStimulus(ExperimentStimulus("crytek_sponza", "path5_seg2_3", 1500, 480, 60, 3.f, 0.4f, 1));
    // manager.addStimulus(ExperimentStimulus("crytek_sponza", "path5_seg2_3", 1500, 720, 120, 3.f, 0.6f, 1));
    // manager.addStimulus(ExperimentStimulus("crytek_sponza", "path5_seg3_3", 2000, 360, 90, 3.f, 0.4f, 2));
    // manager.addStimulus(ExperimentStimulus("crytek_sponza", "path5_seg3_3", 1500, 720, 120, 3.f, 0.6f, 2));

    // manager.addStimulus(ExperimentStimulus("gallery", "path1_seg2_1", 2000, 720, 80, 1, 0.4f, 3));
    // manager.addStimulus(ExperimentStimulus("gallery", "path1_seg2_1", 2000, 1080, 120, 1, 0.6f, 3));
    // manager.addStimulus(ExperimentStimulus("gallery", "path3_seg3_2", 2000, 720, 70, 2, 0.4f, 4));
    // manager.addStimulus(ExperimentStimulus("gallery", "path3_seg3_2", 2000, 1080, 110, 2, 0.6f, 4));
    // manager.addStimulus(ExperimentStimulus("gallery", "path5_seg2_2", 2000, 720, 70, 2.f, 0.4f, 5));
    // manager.addStimulus(ExperimentStimulus("gallery", "path5_seg2_2", 2000, 1080, 110, 2.f, 0.6f, 5));

    // max jod vs 0.6
    // manager.addStimulus(ExperimentStimulus("bedroom", "path2_seg2_3", 1000, 720, 120, 3.f, 0.4f, 0));
    // manager.addStimulus(ExperimentStimulus("bedroom", "path2_seg2_3", 1000, 360, 50, 3.f, 0.6f, 0));
    // manager.addStimulus(ExperimentStimulus("bedroom", "path3_seg2_3", 500, 720, 120, 3.f, 0.4f, 1));
    // manager.addStimulus(ExperimentStimulus("bedroom", "path3_seg2_3", 500, 360, 50, 3.f, 0.6f, 1));
    // manager.addStimulus(ExperimentStimulus("bedroom", "path2_seg3_2", 2000, 720, 120, 2.f, 0.4f, 2));
    // manager.addStimulus(ExperimentStimulus("bedroom", "path2_seg3_2", 2000, 360, 60, 2.f, 0.6f, 2));


    // manager.addStimulus(ExperimentStimulus("bistro", "path3_seg3_1", 2000, 1080, 120, 1.f, 0.4f, 3));
    // manager.addStimulus(ExperimentStimulus("bistro", "path3_seg3_1", 2000, 720, 60, 1.f, 0.6f, 3));
    // manager.addStimulus(ExperimentStimulus("bistro", "path4_seg1_3", 500, 720, 120, 3.f, 0.4f, 4));
    // manager.addStimulus(ExperimentStimulus("bistro", "path4_seg1_3", 500, 360, 60, 3.f, 0.6f, 4));
    // manager.addStimulus(ExperimentStimulus("bistro", "path2_seg1_3", 1000, 720, 120, 3.f, 0.4f, 5));
    // manager.addStimulus(ExperimentStimulus("bistro", "path2_seg1_3", 1000, 360, 70, 3.f, 0.6f, 5));

    // manager.addStimulus(ExperimentStimulus("crytek_sponza", "path1_seg1_3", 1000, 720, 120, 3.f, 0.4f, 0));
    // manager.addStimulus(ExperimentStimulus("crytek_sponza", "path1_seg1_3", 1000, 360, 60, 3.f, 0.6f, 0));
    // manager.addStimulus(ExperimentStimulus("crytek_sponza", "path5_seg2_3", 1500, 720, 120, 3.f, 0.4f, 1));
    // manager.addStimulus(ExperimentStimulus("crytek_sponza", "path5_seg2_3", 1500, 360, 60, 3.f, 0.6f, 1));
    // manager.addStimulus(ExperimentStimulus("crytek_sponza", "path1_seg1_2", 1000, 720, 120, 2.f, 0.4f, 2));
    // manager.addStimulus(ExperimentStimulus("crytek_sponza", "path1_seg1_2", 1000, 360, 70, 2.f, 0.6f, 2));


    // 0.4 vs 0.6
    // manager.addStimulus(ExperimentStimulus("bedroom", "path5_seg1_1", 2000, 720, 70, 1.f, 0.4f, 0));
    // manager.addStimulus(ExperimentStimulus("bedroom", "path5_seg1_1", 2000, 480, 60, 1.f, 0.6f, 0));
    // manager.addStimulus(ExperimentStimulus("bedroom", "path1_seg2_1", 1000, 720, 40, 1.f, 0.4f, 1));
    // manager.addStimulus(ExperimentStimulus("bedroom", "path1_seg2_1", 1000, 480, 30, 1.f, 0.6f, 1));
    // manager.addStimulus(ExperimentStimulus("bedroom", "path1_seg3_2", 2000, 720, 60, 2.f, 0.4f, 2));
    // manager.addStimulus(ExperimentStimulus("bedroom", "path1_seg3_2", 2000, 480, 60, 2.f, 0.6f, 2));

    // manager.addStimulus(ExperimentStimulus("bistro", "path3_seg2_2", 2000, 720, 80, 2.f, 0.4f, 3));
    // manager.addStimulus(ExperimentStimulus("bistro", "path3_seg2_2", 2000, 480, 80, 2.f, 0.6f, 3));
    // manager.addStimulus(ExperimentStimulus("bistro", "path4_seg2_1", 2000, 720, 80, 1.f, 0.4f, 4));
    // manager.addStimulus(ExperimentStimulus("bistro", "path4_seg2_1", 2000, 480, 80, 1.f, 0.6f, 4));
    // manager.addStimulus(ExperimentStimulus("bistro", "path5_seg2_2", 1500, 720, 80, 2.f, 0.4f, 5));
    // manager.addStimulus(ExperimentStimulus("bistro", "path5_seg2_2", 1500, 480, 80, 2.f, 0.6f, 5));

    // manager.addStimulus(ExperimentStimulus("crytek_sponza", "path3_seg1_3", 2000, 720, 80, 3.f, 0.4f, 6));
    // manager.addStimulus(ExperimentStimulus("crytek_sponza", "path3_seg1_3", 2000, 720, 80, 3.f, 0.6f, 6));
    // manager.addStimulus(ExperimentStimulus("crytek_sponza", "path1_seg2_2", 1500, 720, 70, 2.f, 0.4f, 7));
    // manager.addStimulus(ExperimentStimulus("crytek_sponza", "path1_seg2_2", 1500, 480, 70, 2.f, 0.6f, 7));
    // manager.addStimulus(ExperimentStimulus("crytek_sponza", "path2_seg3_3", 2000, 720, 70, 3.f, 0.4f, 8));
    // manager.addStimulus(ExperimentStimulus("crytek_sponza", "path2_seg3_3", 2000, 480, 70, 3.f, 0.6f, 8));

    // manager.addStimulus(ExperimentStimulus("gallery", "path1_seg1_1", 1500, 720, 90, 1.f, 0.4f, 9));
    // manager.addStimulus(ExperimentStimulus("gallery", "path1_seg1_1", 1500, 480, 90, 1.f, 0.6f, 9));
    // manager.addStimulus(ExperimentStimulus("gallery", "path1_seg2_3", 2000, 720, 80, 3.f, 0.4f, 10));
    // manager.addStimulus(ExperimentStimulus("gallery", "path1_seg2_3", 2000, 480, 80, 3.f, 0.6f, 10));
    // manager.addStimulus(ExperimentStimulus("gallery", "path1_seg3_2", 1000, 720, 70, 2.f, 0.4f, 11));
    // manager.addStimulus(ExperimentStimulus("gallery", "path1_seg3_2", 1000, 480, 60, 2.f, 0.6f, 11));
...
void EncodeDecode::loadAllScenes() {
    ...
    mpScenes.push_back(Scene::create(getDevice(), "lost_empire/path1_seg2.fbx"));
    mpScenes.push_back(Scene::create(getDevice(), "lost_empire/path5_seg2.fbx"));


    // mpScenes.push_back(Scene::create(getDevice(), "lost_empire/path5_seg3.fbx"));
    // mpScenes.push_back(Scene::create(getDevice(), "room/path1_seg2.fbx"));
    // mpScenes.push_back(Scene::create(getDevice(), "room/path4_seg1.fbx"));
    // mpScenes.push_back(Scene::create(getDevice(), "room/path4_seg2.fbx"));
    // mpScenes.push_back(Scene::create(getDevice(), "suntemple/path3_seg3.fbx"));

    // mpScenes.push_back(Scene::create(getDevice(), "suntemple/path5_seg1.fbx"));
    // mpScenes.push_back(Scene::create(getDevice(), "suntemple/path2_seg1.fbx"));
    // mpScenes.push_back(Scene::create(getDevice(), "gallery/path5_seg2.fbx"));
    // mpScenes.push_back(Scene::create(getDevice(), "gallery/path3_seg2.fbx"));
    // mpScenes.push_back(Scene::create(getDevice(), "gallery/path1_seg3.fbx"));



    // mpScenes.push_back(Scene::create(getDevice(), "bedroom/path3_seg2.fbx"));
    // mpScenes.push_back(Scene::create(getDevice(), "bedroom/path2_seg2.fbx"));
    // mpScenes.push_back(Scene::create(getDevice(), "bedroom/path2_seg1.fbx"));

    // mpScenes.push_back(Scene::create(getDevice(), "bistro/path3_seg3.fbx"));
    // mpScenes.push_back(Scene::create(getDevice(), "bistro/path4_seg1.fbx"));
    // mpScenes.push_back(Scene::create(getDevice(), "bistro/path4_seg2.fbx"));

    // mpScenes.push_back(Scene::create(getDevice(), "crytek_sponza/path5_seg2.fbx"));
    // mpScenes.push_back(Scene::create(getDevice(), "crytek_sponza/path1_seg1.fbx"));
    ...
    // mpScenes.push_back(Scene::create(getDevice(), "crytek_sponza/path1_seg1.fbx"));
    // mpScenes.push_back(Scene::create(getDevice(), "crytek_sponza/path5_seg2.fbx"));
    // mpScenes.push_back(Scene::create(getDevice(), "crytek_sponza/path5_seg3.fbx"));
    // mpScenes.push_back(Scene::create(getDevice(), "gallery/path1_seg2.fbx"));
    // mpScenes.push_back(Scene::create(getDevice(), "gallery/path3_seg3.fbx"));
    // mpScenes.push_back(Scene::create(getDevice(), "gallery/path5_seg2.fbx"));
    ...
    // mpScenes.push_back(Scene::create(getDevice(), "bedroom/path2_seg2.fbx"));
    // mpScenes.push_back(Scene::create(getDevice(), "bedroom/path3_seg2.fbx"));
    // mpScenes.push_back(Scene::create(getDevice(), "bedroom/path2_seg3.fbx"));
    // mpScenes.push_back(Scene::create(getDevice(), "bistro/path3_seg3.fbx"));
    // mpScenes.push_back(Scene::create(getDevice(), "bistro/path4_seg1.fbx"));
    // mpScenes.push_back(Scene::create(getDevice(), "bistro/path2_seg1.fbx"));
    // mpScenes.push_back(Scene::create(getDevice(), "crytek_sponza/path1_seg1.fbx"));
    // mpScenes.push_back(Scene::create(getDevice(), "crytek_sponza/path5_seg2.fbx"));
    // mpScenes.push_back(Scene::create(getDevice(), "crytek_sponza/path1_seg1.fbx"));

    // 0.4 vs 0.6
    // mpScenes.push_back(Scene::create(getDevice(), "bedroom/path5_seg1.fbx"));
    // mpScenes.push_back(Scene::create(getDevice(), "bedroom/path1_seg2.fbx"));
    // mpScenes.push_back(Scene::create(getDevice(), "bedroom/path1_seg3.fbx"));

    // mpScenes.push_back(Scene::create(getDevice(), "bistro/path3_seg2.fbx"));
    // mpScenes.push_back(Scene::create(getDevice(), "bistro/path4_seg2.fbx"));
    // mpScenes.push_back(Scene::create(getDevice(), "bistro/path5_seg2.fbx"));
...
// 2 mode, 1 is drop jod, the other one is max jod
int runMain(int argc, char** argv)
{
    ...
    config.windowDesc.mode = Falcor::Window::WindowMode::Fullscreen;
